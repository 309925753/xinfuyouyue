...
import com.xfyyim.cn.call.talk.MessageTalkJoinEvent;
import com.xfyyim.cn.call.talk.MessageTalkLeftEvent;
import com.xfyyim.cn.call.talk.MessageTalkOnlineEvent;
import com.xfyyim.cn.call.talk.MessageTalkReleaseEvent;
import com.xfyyim.cn.call.talk.MessageTalkRequestEvent;
...
import com.xfyyim.cn.ui.live.LiveConstants;
...
import static com.xfyyim.cn.bean.message.XmppMessage.TYPE_SEND_DANMU;
...
public class XMuChatMessageListener implements MessageListener {
    ...
    public void processMessage(Message message) {
        ...
        if (com.xfyyim.cn.util.StringUtils.strEquals(message.getPacketID(), "") || message.getPacketID() == null) {
            /**
             ...
             * @see {@link  com.xfyyim.cn.bean.message.NewFriendMessage#toJsonString(boolean)}
             * */
            try {
