...
import com.xfyyim.cn.ui.account.FindPwdActivity;
...
public class MyUpdatePassWordActivity extends BaseActivity implements View.OnClickListener {
    ...
    public MyUpdatePassWordActivity() {
        noLoginRequired();
    }
    ...
    private void initView() {
        ...
        iv_title_left.setOnClickListener(this::onClick);
        ...
        btn_change.setText(getString(R.string.done));
        ...
        HttpUtils.get().url(url)
                ...
                .execute(new BaseCallback<Void>(Void.class) {
                    ...
                    public void onResponse(ObjectResult<Void> result) {
                        ...
                        if (Result.checkSuccess(MyUpdatePassWordActivity.this, result)) {
                            if (isSupportSecureChat) {
                                SecureChatUtil.setFindPasswordStatus(phoneNumber, true);
                            }
                            Toast.makeText(MyUpdatePassWordActivity.this, getString(R.string.update_sccuess), Toast.LENGTH_SHORT).show();
                    ...
                    public void onError(Call call, Exception e) {
                        DialogHelper.dismissProgressDialog();
                        Toast.makeText(MyUpdatePassWordActivity.this, getString(R.string.error_network), Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .execute(new BaseCallback<Code>(Code.class) {
                    ...
                    public void onResponse(ObjectResult<Code> result) {
                        ...
                        if (Result.checkSuccess(mContext, result)) {
                            Toast.makeText(MyUpdatePassWordActivity.this, R.string.verification_code_send_success, Toast.LENGTH_SHORT).show();
