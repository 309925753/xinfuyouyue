...
import com.xfyyim.cn.bean.Label;
...
import com.xfyyim.cn.db.dao.LabelDao;
import com.xfyyim.cn.helper.AvatarHelper;
import com.xfyyim.cn.helper.DialogHelper;
import com.xfyyim.cn.pay.TransferRecordActivity;
import com.xfyyim.cn.ui.MainActivity;
import com.xfyyim.cn.ui.base.BaseActivity;
import com.xfyyim.cn.ui.groupchat.SelectContactsActivity;
import com.xfyyim.cn.ui.message.search.SearchChatHistoryActivity;
...
import com.xfyyim.cn.view.MsgSaveDaysDialog;
import com.xfyyim.cn.view.SelectChatModeDialog;
...
public class PersonSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<com.xfyyim.cn.view.SwitchButton> buttons = new ArrayList<>();
                ...
                .execute(new BaseCallback<Void>(Void.class) {
                    ...
                    public void onResponse(ObjectResult<Void> result) {
                        ...
                        if (result.getResultCode() == 1) {
                            ...
                            sendBroadcast(new Intent(com.xfyyim.cn.broadcast.OtherBroadcast.NAME_CHANGE));// 刷新聊天界面
                        } else {
    ...
    public class RefreshBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(com.xfyyim.cn.broadcast.OtherBroadcast.QC_FINISH)) {
