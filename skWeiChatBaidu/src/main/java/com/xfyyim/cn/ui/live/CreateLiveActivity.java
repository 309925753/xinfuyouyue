...
import com.xfyyim.cn.ui.live.bean.LiveRoom;
...
public class CreateLiveActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Button btn;
    private LinearLayout mHideSoftware;
...
//        ivMenuBg.setImageBitmap(blurBitmap);
        ...
        mHideSoftware = (LinearLayout) findViewById(R.id.hide_software);
