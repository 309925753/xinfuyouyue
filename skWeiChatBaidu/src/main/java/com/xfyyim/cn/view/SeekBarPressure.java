...
public class SeekBarPressure extends View {
    ...
    public SeekBarPressure(Context context, AttributeSet attrs, int defStyle) {
        ...
        notScrollBarBg = getResources().getDrawable(R.drawable.bg_new_my_set_seek_line, null);
        hasScrollBarBg = getResources().getDrawable(R.drawable.bg_new_my_set_seek_line, null);
        mThumbLow = getResources().getDrawable(R.drawable.bg_new_my_set_seek_bar, null);
        mThumbHigh = getResources().getDrawable(R.drawable.bg_new_my_set_seek_bar, null);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBarChangeListener != null) {
         ;
            mBarChangeListener.onProgressChanged(this,    (new Double(progressLow)).intValue(), (new Double(progressHigh)).intValue());
        }
    }
    ...
    public interface OnSeekBarChangeListener {
        //滑动时
        public void onProgressChanged(SeekBarPressure seekBar, int progressLow,
                                      int progressHigh);
    }
