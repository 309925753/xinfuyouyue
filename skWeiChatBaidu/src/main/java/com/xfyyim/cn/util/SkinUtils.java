...
public class SkinUtils {
    ...
    public static List<Skin> defaultSkins = Arrays.asList(
            // 绿色主题，白色标题绿色控件，
            new Skin(R.string.skin_qian_dou_green, 0xffffff, 0xFC607E, true),
            // 蓝色主题，白色标题蓝色控件，
            ...
            // 葡萄紫
            new Skin(R.string.skin_pu_tao_zi, 0xffffff, 0x0303ed, true),
            // 商务蓝
    ...
    public static class Skin {
        ...
        Skin(int colorName, int primaryColor, int accentColor, boolean light) {
            ...
            this.primaryColor = 0xff000000 | 0xfc7079;
