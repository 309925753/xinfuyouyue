...
import com.xfyyim.cn.bean.QQLoginResult;
import com.xfyyim.cn.bean.QQUserInfo;
import com.xfyyim.cn.bean.User;
import com.xfyyim.cn.bean.event.EventUpdateBandQqAccount;
        ...
        synchronized (lock) {
            ...
            loginListener = new IUiListener() {
                ...
                public void onComplete(Object response) {
                    ...
                    LogUtil.e("cjh qq help "+" res  "+response.toString()+"  :  "+loginResult.toString());
                    mTencent.setAccessToken(loginResult.getAccess_token(), String.valueOf(loginResult.getExpires_in()));
